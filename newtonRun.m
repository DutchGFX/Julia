...
points = 600; % points = N, creates NxN grid
xcen = 0; ycen = 0; d = 1;  
...
a = 1 + 0.0i;  % scaling constant for relaxation (stable inside disk of r=1, centered at 1)
c = -1.0 + 4.0i;    % constant term in polynomial
